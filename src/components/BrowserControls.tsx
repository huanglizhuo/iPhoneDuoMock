...
export function BrowserControls({
  ...
  return (
    <div className={`browser-controls ${advanced ? 'expanded' : 'compact'}`}>
      ...
      >
        <label className="field-label">
          <span className="sr-only">{t('browser.address')}</span>
          <input
            id="browser-address"
            type="text"
            inputMode="url"
      ...
      <details className="browser-options" open={advanced || undefined}>
        <summary>{t('browser.more')}</summary>
        ...
        <div hidden={!advanced} className="browser-advanced">
        ...
        <p hidden={!advanced} className="helper-text">
          {t('browser.modeHint')}
        </p>
